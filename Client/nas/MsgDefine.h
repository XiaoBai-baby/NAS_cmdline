...
#define MSG_REMOVE2				0x0107								// 'rm' 指令 2.0, 用于 离线删除
#define MSG_GET					0x0108								// 'get' 指令, 用于 下载文件
#define MSG_PUT					0x0109								// 'put' 指令, 用于 上传文件
#define MSG_HELP				0x0110								// 'help' 指令, 用于 获取指令集
#define MSG_EXIT				0x0111								// 'exit' 指令, 用于 结束会话
...
#define ACK_PATH_END			0x0207								// 一个目录分支树中的全部文件发送完成
#define ACK_FINISH				0x0208								// 全部文件发送完成

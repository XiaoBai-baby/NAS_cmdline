...
public:
	...
	// 删除目录;
	static int rmdir(const string dir);

	// 列出目录中所有文件的大小, 用于辅助 List rmdir使用;
	static long long List_size(const string& dir, bool msg_remove_file = false, bool msg_remove_directory = false);

...
public:
	...
	FileHandler(OS_TcpSocket RecvSock, string homeDir, bool is_win, int size = 1024 * 1024 * 300);
	...
	// 该模板函数 用于类的初始化;
	void operator()(OS_TcpSocket RecvSock, string homeDir, bool is_win, int size = 1024 * 1024 * 300);
...
private:
	int directory_distances;				// 发送目录与根目录之间的关系系数, 即目录的距离;
